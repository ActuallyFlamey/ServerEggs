...
class Migration(migrations.Migration):
    ...
    operations = [
        ops.CreateModel(
            ...
            options={'table': 'guild', 'app': 'eggs', 'pk_attr': 'id'},
            bases=['Model'],
        ),
        ops.CreateModel(
            name='User',
            ...
            options={'table': 'user', 'app': 'eggs', 'pk_attr': 'id'},
            bases=['Model'],
        ),
        ops.CreateModel(
            name='Egg',
            fields=[
                ...
                ('creator', fields.ForeignKeyField('eggs.User', source_field='creator_id', db_constraint=True, to_field='id', related_name='eggs', on_delete=OnDelete.CASCADE)),
                ('origin', fields.ForeignKeyField('eggs.Guild', source_field='origin_id', db_constraint=True, to_field='id', related_name='eggs', on_delete=OnDelete.CASCADE)),
                ('created_at', fields.DatetimeField(auto_now=False, auto_now_add=True)),
                ('edited_at', fields.DatetimeField(auto_now=True, auto_now_add=False)),
            ],
            options={'table': 'egg', 'app': 'eggs', 'pk_attr': 'id'},
            bases=['Model'],
        ),
        ops.CreateModel(
            name='Report',
            fields=[
                ...
                ('egg', fields.ForeignKeyField('eggs.Egg', source_field='egg_id', db_constraint=True, to_field='id', related_name='reports', on_delete=OnDelete.CASCADE)),
                ('reporter', fields.ForeignKeyField('eggs.User', source_field='reporter_id', db_constraint=True, to_field='id', related_name='reports', on_delete=OnDelete.CASCADE)),
                ('reason', fields.CharField(null=True, max_length=200)),
                ('log_message_id', fields.BigIntField(null=True)),
                ('created_at', fields.DatetimeField(auto_now=False, auto_now_add=True)),
            ],
            options={'table': 'report', 'app': 'eggs', 'unique_together': (('egg', 'reporter'),), 'pk_attr': 'id'},
            bases=['Model'],
        ),
    ]
